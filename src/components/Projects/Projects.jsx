...
const projectsData = [
...

  {
    ...
    description:
      "Aplicativo web para criar, visualizar e gerenciar tarefas de forma prática, desenvolvido com React e Tailwind CSS, com armazenamento local (localStorage) para salvar os dados do usuário.",
  ...
  },
  {
    ...
    description:
      "Aplicação web para registrar e gerenciar dados de usuários/clientes de forma intuitiva, criada com React e Tailwind CSS, com recursos de formulário e armazenamento de informações no navegador.",
